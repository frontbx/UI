...
<div class="code-content-example js-docs-playground-swatches">
	<div class="docs-playground-swatches">
		<div class="flex-row-fluid">
			...
			<div class="docs-swatch" style="background: var(--fbx-color-emerland)" data-swatch="var(--fbx-color-emerland)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-nephritis)" data-swatch="var(--fbx-color-nephritis)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-babyblue)" data-swatch="var(--fbx-color-babyblue)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-peterrive)" data-swatch="var(--fbx-color-peterrive)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-belizehol)" data-swatch="var(--fbx-color-belizehol)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-amethyst)" data-swatch="var(--fbx-color-amethyst)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-wisteria)" data-swatch="var(--fbx-color-wisteria)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-wetasphalt)" data-swatch="var(--fbx-color-wetasphalt)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-midnightblue)" data-swatch="var(--fbx-color-midnightblue)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-sunflower)" data-swatch="var(--fbx-color-sunflower)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-orange)" data-swatch="var(--fbx-color-orange)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-carrot)" data-swatch="var(--fbx-color-carrot)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-salmon)" data-swatch="var(--fbx-color-salmon)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-pumpkin)" data-swatch="var(--fbx-color-pumpkin)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-alizarin)" data-swatch="var(--fbx-color-alizarin)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-pomegranate)" data-swatch="var(--fbx-color-pomegranate)"></div>
			<div class="docs-swatch" style="background: var(--fbx-color-clouds)" data-swatch="var(--fbx-color-clouds)"></div>
			...
			<div class="docs-swatch" style="background: var(--fbx-color-hotpink)" data-swatch="var(--fbx-color-hotpink)"></div>
